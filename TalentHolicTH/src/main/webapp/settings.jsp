			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					<div id="logo">
						...
						<a href="main.jsp" class="retina-logo" data-dark-logo="images/talentholic@2x.png"><img src="images/talentholic@2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
 ...
 %> 
            <div class="modal1 mfp-hide" id="upload-profile-picture">
				<div class="accordion accordion-lg divcenter nobottommargin clearfix" style="background-color: #FFF; max-width: 600px; padding: 20px">
					...
					<div class="row">
						<div class="col_full bottommargin center" >
							<br>
