...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<!-- Content
		============================================= -->
		<section id="page-title" class="page-title-parallax page-title-dark" style="padding: 250px 0; background-image: url('img/slides/slide-bg.jpg'); background-size: cover; background-position: center center;" data-bottom-top="background-position:0px 400px;" data-top-bottom="background-position:0px -500px;">
			<div class="vertical-middle">
				<div class="container clearfix">
					...
					<%} %>
					<h3 style='color:#FFF; text-shadow:  10 -4px 20px rgba(0, 0, 0, .25);'><%=user.name %></h3>
					<p><h4 style='color:#FFF; text-shadow:  10 -4px 20px rgba(0, 0, 0, .25);'>D.O.B. : <%=user.dob %>	&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;	GENDER : <%=user.gender %></h4></p>
					<p><h4 style='color:#FFF; text-shadow:  10 -4px 20px rgba(0, 0, 0, .25);'>COLLEGE : <%=user.college %>	&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;	COURSE : <%=user.course %>	&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;	BRANCH : <%=user.branch %> 	&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;	YEAR : <%=user.year %></h4></p>
					<p><h4 style='color:#FFF; text-shadow:  10 -4px 20px rgba(0, 0, 0, .25);'><%=user.bio %></h4></p></div>
						...
						<div id="posts" >
							...
							<div class="entry clearfix`center" style="padding: 10px;border: 1px solid #dcd8d8; box-sizing: border-box;">
								...
								<div class="entry-title center"><% if((user!=null)||soc!=null){%>
									<a href="like?id=<%=pe.id%>&url=profile.jsp"><i class="icon-arrow-up icons"></i><%=le.like %></a>&nbsp;/&nbsp;<a href="dislike?id=<%=pe.id%>&url=profile.jsp"><i class="icon-arrow-down icons"></i><%=le.dislike %></a>&nbsp;/&nbsp;<%} %><a href="#"><i class="icon-folder-open"></i><%=pe.category %></a>&nbsp;/&nbsp;<a href="#"><i class="icon-comments"></i>Comment</a><%if((user.email.equals(pe.email))){ %>&nbsp;/&nbsp;<a href="delete?id=<%=pe.id%>&url=/profile.jsp"><i class="icon-close"></i>Delete</a><%} %>
								</div>
								<%} }%>
								<%if((user!=null)||soc!=null){ %>
								<div class="accordion accordion-lg divcenter nobottommargin clearfix" class="comments" align="left">
									<div class="acctitle"><h7>Comments</h7></div>
