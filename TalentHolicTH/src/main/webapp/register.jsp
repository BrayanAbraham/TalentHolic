			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					<div id="logo">
						...
						<a href="main.jsp" class="retina-logo" data-dark-logo="images/talentholicdark@2x.png"><img src="images/talentholicdark.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
						...
						<div class="acc_content clearfix">
							<form id="register-form" name="register-form" class="nobottommargin" action="reg" method="post">
								...
								<div class="col_full">
									...
									<input type="password" id="register-form-password" name="register-form-password" value="" class="form-control" required minlength="5" />
								</div>
