...
<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
						...
						<ul>
							...
							<li><a href="#"><div>Categories</div></a>
								<ul>
									...
									<li><a href="comingsoon.jsp"><div>Creativity</div></a></li>
				...
				<div class="container clearfix">
					...
					<div class="accordion accordion-lg divcenter nobottommargin clearfix" style="max-width: 550px;">
						...
						<div class="title-content clearfix center" style="max-width: 1200px;">
							<%if(soc.coverkey==null){ %>					
						    	<img class="img-fluid mb-4" src="images/about/parallax.jpg" alt="" height="2000" width="1000" >
							<%}else{
								...
								%>
								<img class="img-fluid mb-4" src="<%=servingUrl%>" alt="" height="200" width="200" style="position:reference; top:500px""><%
							
							}%>
							
							<br><h5><a href="#upload-profile-picture1" data-lightbox="inline">&nbsp;&nbsp;&nbsp;&nbsp;Change Cover Picture</a></h5>
						</div>
						 
						 <div class="title-content clearfix center" style="max-width: 1200px;">
						    <%if(soc.profilekey==null){ %> 
						...
						<div class="acc_content clearfix">
							<form id="Society Settings form" name="Society Settings form" class="nobottommargin" action="societysettings" method="post">
								<div class="col_full">
						...
						<div class="acc_content clearfix">
							<form id="Society Settings form" name="Society Settings form" class="nobottommargin" action="societysettings" method="post">
								...
								<div class="col_full">
									<label for="sochead">change Society Head Name</label>
									<input type="text" id="sochead" name="sochead" value="<%=soc.head %>" class="form-control">
								</div>

								<div class="col_full">
									<label for="phnumber">change Phone Number</label>
									<input type="Number" id="phnumber" name="phnumber" value="<%=soc.phone %>" class="form-control">
								</div>

								<div class="col_full">
									<label for="register-form-bio">Update BIO</label>
									<input class="sm-form-control" id="bio" name="bio" rows="4" cols="30" value="<%=soc.bio %>">
								</div>
 ...
 %> 
            ...
            <div class="modal1 mfp-hide" id="upload-profile-picture1">
				<div class="accordion accordion-lg divcenter nobottommargin clearfix" style="background-color: #FFF; max-width: 600px; padding: 20px">
					<form action="<%= blobstoreService.createUploadUrl("/uploadSocCover") %>" method="post" enctype="multipart/form-data">
					<div class="acctitle"><i class="icon-cloud-upload"></i>Upload Cover Picture</div>
					<div class="row">
						<div class="col_full bottommargin" >
							<br>
							<input type="file" class="file" name="myFile" required>
		    ...
		    <div class="modal1 mfp-hide" id="upload-profile-picture">
				<div class="accordion accordion-lg divcenter nobottommargin clearfix" style="background-color: #FFF; max-width: 600px; padding: 20px">
					<form action="<%= blobstoreService.createUploadUrl("/uploadSocProfile") %>" method="post" enctype="multipart/form-data">
