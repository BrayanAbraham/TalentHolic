				...
				<div class="container clearfix">
					...
					<div class=" divcenter nobottommargin clearfix" style="max-width: 550px;">
						...
						<div class="acc_content clearfix">
							<form id="resetpass-form" name="resetpass-form" class="nobottommargin" action="resetpass" method="post">
								<div class="col_full">
									<label for="resetpass">Enter you email-id to reset your password:</label>
									<input type="text" id="resetpass" name="resetpass-email" value="" class="form-control" />
								</div>
								...
								<div class="col_full nobottommargin">
							     ...
							     <% if((((String)session.getAttribute("checkid"))!=null)){
							        if(((String)session.getAttribute("checkid")).equals("true")) {%>
								    <div class="center">
								    A link to reset your password has been sent to your email-id.
								    </div> 
							    <%} 
							    
							    else if(((String)session.getAttribute("checkid")).equals("false")){%>
								    <div class="center">
								     Email-id is invalid.Please enter your registered email-id.
								    </div> 
							    <%}} %> 
