		...
		<header id="header" class="full-header">
			...
			<div id="header-wrap">
				...
				<div class="container clearfix">
					...
					============================================= -->
					<div id="logo">
						<a href="main.jsp" class="standard-logo" data-dark-logo="images/talentholicdark.png"><img src="images/talentholicdark.png" alt="Canvas Logo"></a>
						<a href="main.jsp" class="retina-logo" data-dark-logo="images/talentholicdark2x.png"><img src="images/talentholicdark2x.png" alt="Canvas Logo"></a>
					</div><!-- #logo end -->
...
<ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenu1">
		...
		<!-- Page Title
		============================================= -->
		<section id="page-title"  style="height: 150px; background: url('img/slides/slide-bg-full.jpg') center center no-repeat; background-size: cover;">

			<div class="container clearfix center">
				<h1 style="color: #FFF">New Event</h1>
			</div>
			...
			<div class="content-wrap">
				...
				<div class="container clearfix">
					...
					<div class="title-content clearfix center" style="max-width: 1200px;">
						...
						<div class="acctitle center">Upload Image:</div>
						<div class="row">
						<%BlobstoreService blobstoreService = BlobstoreServiceFactory.getBlobstoreService(); %>
						<form id="new-event" name="new-event" class="nobottommargin" action="<%= blobstoreService.createUploadUrl("/createevent") %>" method="post"  enctype="multipart/form-data">
							...
							<div class="col-lg-12 bottommargin">
								...
								<div class="col_full">
									<label for="new-event">Name</label>
									<input type="text" name="new-event-name" id="new-event-name" class="required sm-form-control">
								</div>

								<div class="col_full">
									<label for="new-event">location</label>
									<input type="text" name="new-event-location" id="new-event-location" class="required sm-form-control">
								</div>

								<div class="col_half">
									<label for="new-event">Date</label>
									<input type="text" name="new-event-date" id="new-event-date" class="required sm-form-control">
								</div>
								
								<div class="col_half col_last">
									<label for="new-event">Month</label>
									<input type="text" name="new-event-month" id="new-event-month" class="required sm-form-control">								
								</div>

								<div class="col_half">
									<label for="new-event">Event Start Time</label>	
									<input type="Time" name="new-event-start-time" id="new-event-start-time" class="required sm-form-control">
								</div>

								<div class="col_half col_last">
									<label for="new-event">Event End Time</label>
									<input type="Time" name="new-event-end-time" id="new-event-end-time" class="required sm-form-control">
								</div>
								
								<div class="col_full">
									<label for="new-event">Description:</label>
									<textarea class="required sm-form-control" id="new-event-description" name="new-event-description" rows="6" cols="80"></textarea>
								</div>

								<div class="col_full nobottommargin">
									<button class="button button-3d button-black nomargin" id="register-form-submit" name="register-form-submit" value="register">Post</button>
								</div>
