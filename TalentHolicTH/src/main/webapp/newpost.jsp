				...
				<div class="accordion accordion-lg divcenter nobottommargin clearfix" style="background-color: #FFF; max-width: 600px; padding: 20px">
					<form action="<%= blobstoreService.createUploadUrl("/upload") %>" method="post" enctype="multipart/form-data">
						...
						<%-- <div class="row">
							...
							<%BlobstoreService blobstoreService = BlobstoreServiceFactory.getBlobstoreService(); %>
							<form id="upload" name="upload-form" class="nobottommargin" action="<%= blobstoreService.createUploadUrl("/upload") %>" method="post"  enctype="multipart/form-data">
								
								<div class="col_full">
									<label for="upload">Category:</label>
									<select id="upload" name="uploadtype" class="sm-form-control" required>
								...
								<div class="col_full" >
									<label for="upload">Youtube Embeded</label>
									<input type="text" class="sm-form-control" id="upload" name="upload-embed" rows="2" cols="80" placeholder="EMBED LINK"></textarea>
								</div>
